...
const singleSelectQuestion = {
  id: "scope",
  text: "What should the plan target first?",
  options: [
    {
...
const multiSelectQuestion = {
  id: "areas",
  text: "Which areas should this change cover?",
  options: [
    {
      label: "Server",
      description: "Server",
...
describe("buildPendingUserInputAnswers", () => {
  it("treats provider question IDs as ordinary keys, including prototype names", () => {
    const drafts = Object.fromEntries([["__proto__", { customAnswer: "Keep this answer" }]])
    const result = buildPendingUserInputAnswers([{ id: "__proto__" }], drafts)
    expect(Object.hasOwn(result!, "__proto__")).toBe(true)
    expect(result?.["__proto__"]).toBe("Keep this answer")
    ...
    expect(
      buildPendingUserInputAnswers(
        [
          ...
          {
            id: "compat",
            text: "How strict should compatibility be?",
            options: [
              {
