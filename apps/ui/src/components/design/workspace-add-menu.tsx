import { ChartNoAxesColumnIcon, CircleIcon, FolderPlusIcon, GithubIcon, GlobeIcon, MessageSquareIcon, PlusIcon, StickyNoteIcon } from "lucide-react"
...
export const workspaceChoices = [
  ...
  { kind: "browser", label: "GitHub", icon: GithubIcon, url: "https://github.com" },
