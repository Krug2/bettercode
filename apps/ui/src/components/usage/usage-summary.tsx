...
export function UsageInsights({ data, showInsights = true, showTools = true }: { data: UsageDashboard; showInsights?: boolean; showTools?: boolean }) {
  if (!showInsights && !showTools) return null
  ...
  return (
    <div className="usage-insights" style={showInsights !== showTools ? { gridTemplateColumns: "1fr" } : undefined}>
      {showInsights && <section aria-labelledby="usage-insights-title">
      ...
      {showTools && <section aria-labelledby="usage-tools-title">
